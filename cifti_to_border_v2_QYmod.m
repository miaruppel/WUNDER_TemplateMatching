...
IDs = IDs([find(~logical(mod(IDs,1))); find(logical(mod(IDs,1)))]);
...
%         %data_bothhems(:,IDs<1) = 19;%[];
%         %IDs(IDs<1) = 19;%[];
%         %data_bothhems(:,IDs>18) = 19;%[];
%         %IDs(IDs>18) = 19;%[];
...
%     colnames_bothhem = {'Default','Visual','Fronto-Parietal','PrimaryVisual','DorsalAttention','PreMotor','VentralAttentionLanguage','Salience','Cingulo-Opercular','MotorHand','MotorMouth','Auditory','AntMedialTemporal','PostMedialTemporal','Cingulo-Parietal','Parieto-Occipital','MotorFoot','Other','Unknown'};
...
bufsize=16384;
caretdir = '/data/sylvester/data1/CIFTI_RELATED/Resources/32k_ConteAtlas_v2';
...
MNI{1} = gifti(['/data/sylvester/data1/CIFTI_RELATED/Resources/32k_ConteAtlas_v2/Conte69.L.midthickness.32k_fs_LR.surf.gii']); MNI{1} = MNI{1}.vertices;
MNI{2} = gifti(['/data/sylvester/data1/CIFTI_RELATED/Resources/32k_ConteAtlas_v2/Conte69.R.midthickness.32k_fs_LR.surf.gii']); MNI{2} = MNI{2}.vertices;
