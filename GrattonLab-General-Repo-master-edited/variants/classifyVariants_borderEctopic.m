function classifyVariants_borderEctopic(variantsInfoFile, consensusNetsFile, vertexNeighborsFile, distances, outdir)
...
%
% OUTPUTS:
% a CIFTI file for each subject, where border variants have a value of
% 1 and ectopic variants have a value of 2
%
