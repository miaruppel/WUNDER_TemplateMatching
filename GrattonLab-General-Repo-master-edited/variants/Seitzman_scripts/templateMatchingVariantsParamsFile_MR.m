...
surfdatafile = '/data/smyser/smyser4/wunder/wunder_caf_III/TemplateMatching/GrattonLab-General-Repo-master/variants/Seitzman_scripts/test_controls_datalist.txt'; 
...
tmaskfile = '/data/smyser/smyser4/wunder/wunder_caf_III/TemplateMatching/GrattonLab-General-Repo-master/variants/Seitzman_scripts/test_controls_tmasklist.txt';

% List of network variants. The file should contain one column: variantLocation
variantsfile = '/data/smyser/smyser4/wunder/wunder_caf_III/TemplateMatching/GrattonLab-General-Repo-master/variants/Seitzman_scripts/test_controls_variantslist.txt';
...
templatesfile = '/data/smyser/smyser4/wunder/wunder_caf_III/TemplateMatching/GrattonLab-General-Repo-master/variants/Seitzman_scripts/networkTemplates.mat'; 
