function fcimage_corrmat_volume(datafile,FCdir,atlas_dir,atlas)
...
%
% EXAMPLE: fcimage_corrmat_volume('EXAMPLESUB_DATALIST.xlsx','/projects/b1081/Atlases/','/projects/b1081/iNetworks/Nifti/derivatives/preproc_FCProc/','Seitzman300')
% Requires scripts from lab Scripts folder to be in path (/projects/b1081/Scripts or /gpfs/research/grattonlab/Scripts)
%
% CG - 03.26.2020
%%%%%%%%%%%%%%%%%
